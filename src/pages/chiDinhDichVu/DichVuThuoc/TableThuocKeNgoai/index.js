...
const TableThuocKeNgoai = ({
  ...
  const onChangePage = (page) => {
    getDataThuoc(state.keyWord, state.boChiDinhSelected?.id, page - 1, size);
  };
  const onSizeChange = (value) => {
    getDataThuoc(state.keyWord, state.boChiDinhSelected?.id, 1, value);
  };
      ...
      <div className="content-left">
        <Row justify="space-between" align="middle">
          <div className="input-box">
            ...
            <InputTimeout
              style={{ flex: 1, height: 32, marginLeft: 0 }}
              ref={refInput}
