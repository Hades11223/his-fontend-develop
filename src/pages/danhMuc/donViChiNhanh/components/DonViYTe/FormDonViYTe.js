            ...
            <Col span={12}>
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Vui lòng nhập mã đơn vị y tế!",
                  },
                  {
                    max: 20,
                    message: "Vui lòng nhập mã đơn vị y tế không quá 20 ký tự!",
                  },
                  {
                    whitespace: true,
                    message: "Vui lòng nhập mã đơn vị y tế!",
              ...
              >
                <Input
                  ...
                  placeholder="Vui lòng nhập mã đơn vị y tế"
                />
              </Form.Item>
            </Col>
            <Col span={12}>
              <Form.Item
                label="Tên đơn vị y tế"
                name="ten"
                style={{ width: "100%" }}
                rules={[
                  {
                    required: true,
                    message: "Vui lòng nhập tên đơn vị y tế!",
                  },
                  {
                    whitespace: true,
                    message: "Vui lòng nhập tên đơn vị y tế!",
              ...
              >
                <Input
                  className="input-option"
                  placeholder="Vui lòng nhập tên đơn vị y tế"
                />
              </Form.Item>
            </Col>
          </Row>
