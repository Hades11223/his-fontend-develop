...
import TraTheoDichVu from "./TraTheoDichVu";
...
const ChiTietPhieuTra = ({}) => {
  ...
  const listPanel = [
    {
      title: "Danh sách trả theo dịch vụ",
      component: <TraTheoDichVu refSetting={refSetting} />,
    },
    {
  ...
  return (
    <ScreenPhieuLinh.LayoutChiTiet
      title="Chi tiết phiếu trả suất ăn"
      chains={[
        ...
        {
          title: "Chi tiết phiếu trả suất ăn",
          link: "/quan-ly-noi-tru/chi-tiet-phieu-tra-suat-an/" + id,
        },
      ]}
      listPanel={listPanel}
