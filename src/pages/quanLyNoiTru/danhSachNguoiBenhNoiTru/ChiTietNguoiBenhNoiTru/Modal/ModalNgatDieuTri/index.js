...
const ModalNgatDieuTri = (props, ref) => {
  ...
  const {
    danhSachNguoiBenhNoiTru: { ngatDieuTri, getNbNoiTruById },
    ...
    if (state?.show) {
      ...
      let info = {
        ...
        thoiGianRaVien:
          ...
          moment(nbThongTinRaVien?.thoiGianRaVien) : moment(),
        thoiGianTuVong:
  ...
  return (
    <ModalTemplate
      width={800}
      ref={refModal}
      title={t("quanLyNoiTru.ngatDieuTri")}
      rightTitle={
        <>
...
export default forwardRef(ModalNgatDieuTri);
